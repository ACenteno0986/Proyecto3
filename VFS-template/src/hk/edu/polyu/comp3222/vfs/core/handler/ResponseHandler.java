...
public abstract class ResponseHandler implements Serializable{
     ...
     */
    public abstract VFSunit handlerResponse(String[] cmd, VirtualDisk currentDisk, VFSDirectory root, VFSDirectory CurrentDir);
     ...
     * @return current directory after command is handled
     */
    public VFSDirectory saveState(String[] cmd, VirtualDisk currentDisk, VFSDirectory root, VFSDirectory CurrentDir){
        this.cmd = cmd;
